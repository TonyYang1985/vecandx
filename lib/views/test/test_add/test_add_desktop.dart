...
part of test_add_view;

class _TestAddDesktop extends StatefulWidget {
  final TestAddViewModel viewModel;

  _TestAddDesktop(this.viewModel);

  @override
  __TestAddDesktopState createState() => __TestAddDesktopState();
}

class __TestAddDesktopState extends State<_TestAddDesktop> {
                ...
                ReactiveFormConsumer(
                  builder: (context, form, child) {
                    return FloatingActionButton.extended(
                      ...
                      heroTag: 'saveBtn',
                      onPressed: form.valid && !widget.viewModel.isLoading
                          ? () => widget.viewModel.addPatientTest(
                                PatientTest.fromMap(form.value),
                                onAddedTest: (_) => form.reset(),
                              )
                          : null,
                      tooltip: 'Save test',
                      mouseCursor: form.valid ? SystemMouseCursors.click : SystemMouseCursors.forbidden,
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: Text(
                                  'Test performed by: ${storageService.authUser.fullName}',
                                  style: TextStyle(fontSize: 16),
                                ),
                              ),
                              SizedBox(height: 10),
